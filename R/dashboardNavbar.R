...
#'
#' Build an blue dashboard navbar
#'
#' @param ... Any element such as \link{blueDropNav}.
#'
#' @author David Granjon, \email{dgranjon@@ymail.com}
#'
#' @export
blueDashNavbar <- function(...) {
  shiny::tags$nav(
...
#'
#' Build an blue dashboard dropdown menu
#'
#' @param ... slot for \link{blueDropNavItem}, \link{blueDropNavTitle} or \link{blueDropNavDivider}.
...
#'
#' @export
blueDropNav <- function(..., title = NULL, src = NULL, orientation = "right") {
...
#'
#' Build an blue dashboard dropdown menu item
#'
#' @param title Item title.
#' @param src External link.
#' @param icon Icon, if any. Expect \link{blueIcon} or \link[shiny]{icon}. 
#'
#' @author David Granjon, \email{dgranjon@@ymail.com}
#'
#' @export
blueDropNavItem <- function(title = NULL, src = NULL, icon = NULL) {
  shiny::tags$a(
    class = "dropdown-item",
    href = src,
    target = "_blank",
...
#'
#' Build an blue dashboard dropdown menu title
#'
#' @param title Menu title.
#'
#' @author David Granjon, \email{dgranjon@@ymail.com}
#'
#' @export
blueDropNavTitle <- function(title = NULL) {
  shiny::tags$div(
...
#'
#' Build an blue dashboard dropdown menu divider
#'
#' @author David Granjon, \email{dgranjon@@ymail.com}
#'
#' @export
blueDropNavDivider <- function() {
