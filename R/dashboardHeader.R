...
#'
#' Build an blue dashboard header
#'
#' @param ... Any element 
#' @param gradient Whether to apply a gradient effect. TRUE by default.
#' @param color Header color. See \url{https://demos.creative-tim.com/blue-design-system/docs/foundation/colors.html}.
...
#'
#' @export
blueDashHeader <- function(..., gradient = TRUE, color = NULL, separator = FALSE, 
