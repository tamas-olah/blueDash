...
#'
#' Build an blue dashboard body
#'
#' @param ... Body content, slot for \link{blueTabItems}
#' 
#' @author David Granjon, \email{dgranjon@@ymail.com}
#'
#' @export
blueDashBody <- function(...) {
  shiny::tags$div(
...
#'   \code{\link{blueTabItem}}.
#'   
#' @export
blueTabItems <- function(...) {
...
#'   of a \code{\link{blueSidebarItem}}.
#' @param ... Contents of the tab.
#' 
#' @export
blueTabItem <- function(tabName = NULL, ...) {
  if (is.null(tabName))
    stop("Need tabName")
