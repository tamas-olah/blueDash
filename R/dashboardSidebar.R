...
#'
#' Build an blue dashboard sidebar
#'
#' @param ... Any element such as \link{blueDashSidebar}, \link{blueSidebarMenu},
#' \link{blueSidebarItem}, \link{blueSidebarHeader} and \link{blueSidebarDivider}.
#' 
...
#' @param background Sidebar background color. See \url{https://demos.creative-tim.com/blue-design-system/docs/foundation/colors.html}.
#'
#' @author David Granjon, \email{dgranjon@@ymail.com}
#'
#' @export
blueDashSidebar <- function(..., dropdownMenus = NULL, id, brand_url = NULL, brand_logo = NULL, 
...
#' Create a Boostrap 4 blue sidebar menu
#'
#' Build an blue dashboard main sidebar menu
#'
#' @param ... Slot for \link{blueSidebarItem}.
#' 
#' @author David Granjon, \email{dgranjon@@ymail.com}
#'
#' @export
blueSidebarMenu <- function(...) {
  shiny::tags$div(
...
#'
#' @param ... Item name.
#' @param tabName Should correspond exactly to the tabName given in \code{\link{blueTabItem}}.
#' @param icon Item icon. \link{blueIcon} or \link[shiny]{icon}.
#' 
#' @author David Granjon, \email{dgranjon@@ymail.com}
#'
#' @export
blueSidebarItem <- function(..., tabName = NULL, icon = NULL) {
  shiny::tags$a(
...
#' A header to put inside \link{blueDashSidebar}
#' 
#' @param title Header title
#'
#' @export
blueSidebarHeader <- function(title = NULL) {
  shiny::tags$h6(class = "navbar-heading text-muted", title)
}


#' A divider to put inside \link{blueDashSidebar}
#'
#' @export
blueSidebarDivider <- function() {
